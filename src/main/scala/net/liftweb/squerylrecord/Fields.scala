...
class UnownedDoubleField(v: Double) extends DoubleTypedField { set(v) }
class UnownedLongField(v: Long) extends LongTypedField { set(v) }
class UnownedBooleanField(v: Boolean) extends BooleanTypedField { set(v) }
